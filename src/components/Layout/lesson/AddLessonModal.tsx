...
const AddLessonModal: React.FC<ModalProps> = ({
  ...
  <div className="bg-white rounded-lg shadow-lg p-3 w-11/12 max-w-lg">
    <h2 className="text-sm font-semibold text-gray-800 mb-3">Agregar Lección</h2>
    <form
      onSubmit={(e) => {
        e.preventDefault();
        handleSubmit(() => {
    ...
    >
      <div>
        <label className="block text-xs font-medium text-gray-700">Tema</label>
        <input
          type="text"
          name="tema"
      ...
      <div>
        <label className="block text-xs font-medium text-gray-700">Pasaje</label>
        <input
          type="text"
          name="pasaje_biblico"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="block text-xs font-medium text-gray-700">Grupo</label>
          <select
            name="id_grupo"
        ...
        <div>
          <label className="block text-xs font-medium text-gray-700">Maestra</label>
          <select
            name="id_maestra"
