...
const Aside = ({ isOpened }: asideProps) => {
  return (
    <>
      <aside
        id="default-sidebar"
        className={`fixed inset-y-18 left-0 z-10 h-full w-42 sm:w-64 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 transform transition-transform duration-300 ease-in-out ${
          isOpened ? "translate-x-0" : "-translate-x-full"
        }`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 shadow-md z-20">
