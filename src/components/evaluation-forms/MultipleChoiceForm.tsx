...
import { MultipleChoiceQuestion } from '../../Types/evaluation';

type Props = {
  onBack: () => void;
};

export default function MultipleChoiceForm({ onBack }: Props) {
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 rounded-lg shadow">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Create Multiple Choice Quiz</h2>
                  ...
                  {question.options.map((option, optionIndex) => (
                    <div key={option.id} className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={() => {
                          const newQuestions = [...questions];
                          newQuestions[index].correctAnswer = option.id;
                          setQuestions(newQuestions);
                        }}
