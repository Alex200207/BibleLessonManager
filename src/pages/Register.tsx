    ...
    <AuthLayout>
      <div
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden max-w-md w-full">
          <div className="p-6">
            <h4 className="text-2xl font-bold text-center">Registrarse en AlexStore</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <button type="submit" className="w-full bg-cyan-600 text-white py-2 rounded hover:bg-cyan-700 transition duration-200">
                  Registrarse
                </button>
              </div>
              <div className="text-center mt-4">
                <label>
                  ¿Ya tienes cuenta? <a href="/login" className="text-cyan-600 hover:underline">Inicia sesión</a>
                </label>
              </div>
            </form>
          </div>
